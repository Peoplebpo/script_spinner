...
<div class="col-2" id="venta" style="display:none;">
    ...
    <label class="form-check-label fw-bold" for="flexRadioDefault1"><input class="form-check-input boton radio" type="radio" name="flexRadioDefault" id="radio_button"> Solo Descuento
	</label>
    </div>
</div>
...
<div class="col-12" id="venta8" style="display:none;">
    ...
    <div class="col-3 mt-5" id="venta1" style="display:none;">
		...
		<input type="date" class="form-control mt-2" name="fecha_retiro" id="fecha_retiro">

    </div>

    <div class="col-3 mt-5" id="venta2" style="display:none;">
    ...
    <div class="col-3 mt-5" id="venta3" style="display:none;">
    	
    	<label class="fw-bold">Equipo Aceptado</label>
		<input type="name" name="equipo_aceptado" id="equipo_aceptado" class="form-control my-2">

		<label class="fw-bold texto">Numero de Interacción ONE Línea Principal</label>
		<input type="name" name="num_interaccion" id="num_interaccion" class="form-control my-2">
    ...
    <div class="col-12 mt-3 p-0" id="venta5" style="display:none;">

    <button type="button" class="btn_script btn btn-primary btn-xs text-white my-2" style="float:right;" onclick="i_siempre();" id="btn_info_siempre1">Informar Siempre</button></a>

    <button type="button" class="btn_script btn btn-danger btn-xs text-white my-2" style="float:right; margin-right: 5px;" onclick="l_adicional();" id="btn_linea_add">Lineas Adicionales</button></a>

    <button type="button" class="btn_script btn btn-warning btn-xs text-white my-2" style="float:right; margin-right: 5px;" onclick="g_glosa();" id="btn_g_grosa">Generador de Glosa</button></a>

    <button type="button" class="btn_script btn btn-secondary btn-xs text-white my-2" style="float:right; margin-right: 5px;" onclick="inicio();" id="btn_inicio1">Inicio</button>     
