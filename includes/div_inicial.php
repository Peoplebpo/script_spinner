		...
		<div class="col-5" style="float: left;" id="inicial2">
			...
			<input type="name" name="plan_actual" id="plan_actual" class="form-control my-2" disabled="disabled">

			<label class="fw-bold">Minutos</label>
			<input type="name" name="minutos" id="minutos" class="form-control my-2" disabled="disabled">

			<label class="fw-bold">Promedio de Consumo</label>
			<input type="name" name="consumo" id="consumo" class="form-control my-2" disabled="disabled">
		...
		<div class="col-5" style="float: left; margin: 0px 0px 10px 20px;" id="inicial3">
			...
			<input type="name" name="c_fijos" id="c_fijos" class="form-control my-2" disabled="disabled">

			<label class="fw-bold">GB</label>
			<input type="name" name="gb" id="gb" class="form-control my-2" disabled="disabled">
